...
public class GUIButtonBasic extends GUIButton {
     ...
     */
    public GUIButtonBasic(ItemStack item, boolean visible, ClickAction clickAction) {
        this.item = item;
     ...
     */
    public GUIButtonBasic(ItemStack item) {
        this.item = item;
    }
    ...
    public interface ClickAction {
        ...
        class Click {
            ...
            public Click(GUIButtonBasic button, InventoryClickEvent event) {
                this.button = button;
                this.event = event;
            }
        }
