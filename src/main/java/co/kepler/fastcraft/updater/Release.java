...
public class Release implements Comparable<Release> {
    ...
    private static final File RELEASES_DIR = new File(FastCraft.getInstance().getDataFolder(), "releases");
    private static final String JAR_FILENAME = "FastCraft v%s.jar";
    ...
    public void install() throws IOException {
        ...
        String filename = FastCraft.getJarFile().getName();
            ...
            for (int i = 0; i < releaseNodes.getLength(); i++) {
                ...
                try {
                    ...
                    if (versionStr == null || stableStr == null || urlStr == null || md5 == null) {
                        FastCraft.debug("Unable to fetch release with invalid attributes:");
                        FastCraft.debug(String.format("version=%1s, stable=%2s, url=%3s, md5=%4s",
    ...
    public void download(DownloadListener listener) {
        ...
        try {
            ...
            if (releaseFile.getParentFile().mkdirs()) FastCraft.log("Created releases directory");
